 ...
 */
class CliWrapper {
    constructor(accessKey, spawn = child_process_1.default.spawn) {
        this.accessKey = accessKey;
        this.spawn = spawn;
    }
    download(params) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.execute("download", [`'${params.projectName}'`, `'${params.destDir}'`], params.verbose);
        });
    }
    run(params) {
        return __awaiter(this, void 0, void 0, function* () {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core_1 = __webpack_require__(186);
const cli_wrapper_1 = __webpack_require__(688);
const runner_1 = __webpack_require__(878);
const test_lister_1 = __webpack_require__(651);
const test_runner_1 = __webpack_require__(848);
const util_1 = __webpack_require__(629);
const accessKey = core_1.getInput("access-key", { required: true });
const cliWrapper = new cli_wrapper_1.CliWrapper(accessKey);
const testLister = new test_lister_1.TestLister(cliWrapper);
const testRunner = new test_runner_1.TestRunner(cliWrapper);
const runner = new runner_1.Runner(testLister, testRunner, core_1.info);
runner
    .run({
    projectName: core_1.getInput("project", { required: true }),
 ...
 */
class Runner {
    constructor(testLister, testRunner, log) {
        this.testLister = testLister;
...
class TestLister {
    ...
    listAll(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const output = yield this.cliWrapper.download(Object.assign({ projectName: params.projectName, destDir }, (params.verbose ? { verbose: params.verbose } : {})));
            return output
...
class TestRunner {
    ...
    run(params) {
        return __awaiter(this, void 0, void 0, function* () {
            const output = yield this.cliWrapper.run(params);
            const steps = output
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getAsBoolean = void 0;
exports.getAsBoolean = (input) => ["true", "TRUE", "1", 1, true].includes(input);
